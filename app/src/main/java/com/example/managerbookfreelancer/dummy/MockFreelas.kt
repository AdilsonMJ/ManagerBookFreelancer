...
object MockFreelas : JobsRepository {
    ...
    val freelancerJobsList: MutableList<JobModel> = mutableListOf(
        ...
        JobModel(
            engaged = EngagedModel(bride_name = "Luciani", bridegroom_name = "Fernando"),
            ownerJob = OwnerJob(owner_name = "Nilton", cellphone = "99998899"),
            weedingDay = WeedingDayModel(data = "21/11/2023")
