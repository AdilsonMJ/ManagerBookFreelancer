...
class AdapterListJobs(
    ...
    private val asyncListDiff : AsyncListDiffer<JobModelItem> = AsyncListDiffer(this,
        DiffCalback
    )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterListJobs.viewHolder {
    ...
    override fun onBindViewHolder(holder: AdapterListJobs.viewHolder, position: Int) {
